...
//--------------------------------------------------------------------------------
//Command: generate_target bd_d1e6.bd
//Design : bd_d1e6
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_d1e6,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_d1e6,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "PL_X_ddr4_1_0_microblaze_mcs.hwdef" *) 
module bd_d1e6
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_d1e6_Clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_d1e6 lmb_bram_I bd_d1e6 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_d1e6_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_d1e6_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_d1e6_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_d1e6_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_d1e6 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_d1e6_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_d1e6_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_d1e6_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_d1e6_second_lmb_bram_I_0 second_lmb_bram_I
