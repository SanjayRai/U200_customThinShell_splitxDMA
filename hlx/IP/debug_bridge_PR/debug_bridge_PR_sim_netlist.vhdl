...
--               /home/sanjayr/projects/Illumina/U200_Eclipse/THIN_SHELL/u200_hlx_v16_ASYNC_ICAP_DLY_EXT_ICAP_WITH_CRC_CMC_2020_1/hlx/IP/debug_bridge_PR/debug_bridge_PR_sim_netlist.vhdl
...
entity debug_bridge_PR_bd_8d7d is
  port (
  ...
  attribute HW_HANDOFF of debug_bridge_PR_bd_8d7d : entity is "debug_bridge_PR.hwdef";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of debug_bridge_PR_bd_8d7d : entity is "bd_8d7d";
end debug_bridge_PR_bd_8d7d;

architecture STRUCTURE of debug_bridge_PR_bd_8d7d is
  component debug_bridge_PR_bd_8d7d_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  end component debug_bridge_PR_bd_8d7d_lut_buffer_0;
  component debug_bridge_PR_bd_8d7d_xsdbm_0 is
  port (
    update : in STD_LOGIC;
  ...
  end component debug_bridge_PR_bd_8d7d_xsdbm_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN bd_8d7d_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
begin
lut_buffer: component debug_bridge_PR_bd_8d7d_lut_buffer_0
     port map (
...
xsdbm: component debug_bridge_PR_bd_8d7d_xsdbm_0
     port map (
...
entity debug_bridge_PR is
  ...
  attribute NotValidForBitStream of debug_bridge_PR : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of debug_bridge_PR : entity is "debug_bridge_PR,bd_8d7d,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of debug_bridge_PR : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of debug_bridge_PR : entity is "bd_8d7d,Vivado 2020.1";
end debug_bridge_PR;

architecture STRUCTURE of debug_bridge_PR is
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of inst : label is "debug_bridge_PR.hwdef";
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of S_BSCAN_bscanid_en : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN BSCANID_EN";
  attribute X_INTERFACE_INFO of S_BSCAN_capture : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN CAPTURE";
  attribute X_INTERFACE_INFO of S_BSCAN_drck : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN DRCK";
  ...
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN bd_8d7d_clk, INSERT_VIP 0";
begin
inst: entity work.debug_bridge_PR_bd_8d7d
     port map (
